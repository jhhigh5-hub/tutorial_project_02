...
<head>
    <title>Title</title>
    <link rel="stylesheet" href="/css/approve-request.css">
</head>
<body>
...
<main class="main-content">
    <div class="content">
        ...
        <c:choose>
                    ...
                    <c:forEach var="request" items="${pendingRequests}">
                        <tr>
                            ...
                            <td class="action-buttons">
                                <form action="/band/join-request-manage" method="post">
            ...
            <c:otherwise>
                <p class="no-result">현재 대기 중인 가입 요청이 없습니다.</p>
            </c:otherwise>
        </c:choose>

        <a href="/band/board?no=${band.no}" class="back-link">밴드 페이지로 돌아가기</a>
    </div>
</main>
